...
export const communityAPI = {
  ...
  update:       (id, data) => api.patch(`/community/${id}`, data),
  remove:       (id)     => api.delete(`/community/${id}`),
  addAnswer:    (id, content) => api.post(`/community/${id}/answers`, { content }),
  editAnswer:   (id, answerId, content) => api.patch(`/community/${id}/answers/${answerId}`, { content }),
  deleteAnswer: (id, answerId) => api.delete(`/community/${id}/answers/${answerId}`),
