export default function RefundPage() {
  const sections = [
    ...
    },
    {
      ...
      body: "Email: trustbridge.platform@gmail.com · Owners: Nasani Ragamala and M. Sindhuja · Business Location: Hanamkonda, Telangana, India · Support Hours: Monday – Saturday, 9:00 AM – 6:00 PM IST",
    },
  ];
    ...
    <div style={{ background: "#f8fafc", minHeight: "100vh", fontFamily: "Inter,system-ui,sans-serif" }}>
      <div style={{ background: "white", borderBottom: "1px solid #e2e8f0", padding: "32px 0" }}>
        <div className="wrap">
          ...
          <p style={{ fontSize: 13, color: "#64748b", margin: 0 }}>Last updated: June 2026 · Owners: Nasani Ragamala and M. Sindhuja</p>
        </div>
      </div>
      <div className="wrap" style={{ paddingTop: 36, paddingBottom: 56, maxWidth: 760 }}>
        <div style={{ background: "white", border: "1.5px solid #e2e8f0", borderRadius: 16, padding: "32px 36px", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
          <p style={{ fontSize: 13, color: "#64748b", lineHeight: 1.75, marginBottom: 32 }}>
            ...
            <strong style={{ color: "#0f172a" }}>Nasani Ragamala and M. Sindhuja</strong>.
